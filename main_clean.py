...
def prepare_data():
    ...
    #2.1.4 load dataset
    #2.1.4.1 sampling
    train_dataset, val_dataset, test_dataset = AgriDataset(train_data_list), AgriDataset(val_data_list,train=False), AgriDataset(test_files,test=True)  
    ...
    val_dataloader = DataLoader(val_dataset,batch_size=config.batch_size,shuffle=True,collate_fn=collate_fn,pin_memory=False)
